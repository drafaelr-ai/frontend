...
const EditarPagamentoFuturoModal = ({ onClose, onSave, pagamento, itensOrcamento = [] }) => {
    ...
    return (
        <Modal
            ...
            subtitle={pagamento.descricao}
            width="large"
            scrollBody={true}
            footer={
                <>
                    <button type="button" className="m-btn-cancel" onClick={onClose}>Cancelar</button>
                    <button type="submit" form="form-editar-pagamento-futuro" className="m-btn-primary" style={{ background: 'var(--module-obras)' }}>
        ...
        >
            <form id="form-editar-pagamento-futuro" onSubmit={handleSubmit}>
